...
import 'package:stock_shift_pro/data/network/api_services/interceptors/retry_interceptor.dart';
...
class NetworkApiService implements BaseApiServices {
  ...
  Future<Response> _retryRequest(RequestOptions options) async {
    ...
    throw Exception('Failed to retry after 3 attempts');
  }
    ...
    switch (response.statusCode) {
      ...
      case 500:
        ...
        throw InternalServerException(
          body['message'] ?? AppStrings.serverError,
        );
      default:
  ...
  Exception _handleDioException(DioException e) {
    ...
    if (e.type == DioExceptionType.connectionTimeout ||
      ...
      return NoInternetException(AppStrings.noInternet);
    } else {
      return FetchDataException(AppStrings.serverError);
    }
  }
...
//     while (attempt < retries) {
//       try {
//         // Use the correct type for the request (Options).
//         final response = await _dio.request(
//           options.path,
//           options: Options(
//             method: options.method,
...
//         attempt++;
//         if (attempt == retries) {
//           rethrow; // throw after final attempt
//         }
...
//       return FetchDataException(AppStrings.timeoutError);
//     } else if (e.type == DioExceptionType.badResponse) {
//       // Here, delegate to _returnResponse to throw detailed errors
//       return _returnResponse(e.response!);
//     } else if (e.type == DioExceptionType.unknown &&
//         e.error is SocketException) {
//       return NoInternetException(AppStrings.noInternet);
